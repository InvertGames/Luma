...
namespace FlipCube {
    ...
    public partial class NotificationsUISystemBase : uFrame.ECS.EcsSystem {
        ...
        public override void Setup() {
            ...
            this.OnEvent<FlipCube.NotificationMessage>().Subscribe(_=>{ DisplayNotificationMessageFilter(_); }).DisposeWith(this);
        }
        ...
        protected virtual void DisplayNotificationMessageHandler(FlipCube.NotificationMessage data, NotificationUI group) {
        }
        
        protected void DisplayNotificationMessageFilter(FlipCube.NotificationMessage data) {
            var NotificationUIItems = NotificationUIManager.Components;
            for (var NotificationUIIndex = 0
            ; NotificationUIIndex < NotificationUIItems.Count; NotificationUIIndex++
            ) {
