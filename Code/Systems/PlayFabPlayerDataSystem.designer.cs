...
namespace FlipCube {
    ...
    public partial class PlayFabPlayerDataSystemBase : uFrame.ECS.EcsSystem {
        ...
        public override void Setup() {
            ...
            this.OnEvent<FlipCube.LoadData>().Subscribe(_=>{ LoadCloudDataFilter(_); }).DisposeWith(this);
            this.OnEvent<FlipCube.SaveData>().Subscribe(_=>{ SaveCloudDataFilter(_); }).DisposeWith(this);
            CloudDataManager.CreatedObservable.Subscribe(LoadCloudDataComponentFilter).DisposeWith(this);
        }
        
        protected virtual void LoadCloudDataHandler(FlipCube.LoadData data) {
        }
        
        protected void LoadCloudDataFilter(FlipCube.LoadData data) {
            this.LoadCloudDataHandler(data);
        }
        
        protected virtual void SaveCloudDataHandler(FlipCube.SaveData data) {
        }
        
        protected void SaveCloudDataFilter(FlipCube.SaveData data) {
