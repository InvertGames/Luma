...
namespace DarkTonic.MasterAudio {
    ...
    public class MasterAudio : MonoBehaviour {
        ...
        public float defaultDuckedVolumeMultiplier = .5f;
        ...
        public static void DuckSoundGroup(string soundGroupName, AudioSource aSource) {
            ...
            for (var i = 0; i < pcs.Count; i++) {
                pcs[i].DuckMusicForTime(duckLength, matchingDuck.unduckTime, duckPitch, matchingDuck.riseVolStart, matchingDuck.duckedVolumeMultiplier);
            }
        }
        /*! \endcond */
        ...
        /// <param name="duckedVolMult">Percentage of original volume</param>
        ...
        public static void AddSoundGroupToDuckList(string sType, float riseVolumeStart, float duckedVolMult, float unduckTime) {
            ...
            var newDuck = new DuckGroupInfo() {
                ...
                duckedVolumeMultiplier = duckedVolMult,
        ...
        public float DuckedVolumeMultiplier {
            get { return defaultDuckedVolumeMultiplier; }
            set {
                defaultDuckedVolumeMultiplier = value;
