...
public static class DTGUIHelper {
    ...
    public static DTFunctionButtons AddCustomEventDeleteIcon(bool showRenameButton) {
		...
		var shouldDelete = GUILayout.Button(new GUIContent(deleteIcon, "Click to delete Custom Event"), EditorStyles.toolbarButton, GUILayout.MaxWidth(32));
	...
	public static float DisplayPitchField(float pitch, string fieldName = "Pitch") {
		if (!MasterAudio.UseCentsForPitch) {
			return EditorGUILayout.Slider("Pitch", pitch, -3f, 3f);
		} 
