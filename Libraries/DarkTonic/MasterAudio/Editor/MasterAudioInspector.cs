...
public class MasterAudioInspector : Editor {
    ...
    public override void OnInspectorGUI() {
        ...
        EditorGUI.indentLevel = 0;
        GUI.color = _sounds.showLocalization ? ActiveClr : InactiveClr;
        EditorGUILayout.BeginHorizontal(EditorStyles.objectFieldThumb);

        var newLoc = EditorGUILayout.Toggle("Show Languages", _sounds.showLocalization);
        if (newLoc != _sounds.showLocalization) {
            UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _sounds, "toggle Show Languages");
            _sounds.showLocalization = newLoc;
        }
        EditorGUILayout.EndHorizontal();
        ...
        EditorGUI.indentLevel = 0;
        GUI.color = _sounds.showAdvancedSettings ? ActiveClr : InactiveClr;
        EditorGUILayout.BeginHorizontal(EditorStyles.objectFieldThumb);

        var newAdv = EditorGUILayout.Toggle("Show Advanced", _sounds.showAdvancedSettings);
        if (newAdv != _sounds.showAdvancedSettings) {
            UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _sounds, "toggle Show Advanced");
            _sounds.showAdvancedSettings = newAdv;
        }
        EditorGUILayout.EndHorizontal();
        GUI.color = Color.white;
        ...
        if (_sounds.showAdvancedSettings) {
            ...
            var newAutoPrioritize = EditorGUILayout.Toggle(new GUIContent("Apply Distance Priority", "Turn this on to have Master Audio automatically assign Priority to all audio, based on distance from the Audio Listener. Playlist Controller and 2D sounds are unaffected."), _sounds.prioritizeOnDistance);
            ...
            var newVisual = EditorGUILayout.BeginToggleGroup("Show Visual Settings", _sounds.visualAdvancedExpanded);
            if (newVisual != _sounds.visualAdvancedExpanded) {
                UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _sounds, "toggle Show Visual Settings");
            ...
            EditorGUILayout.Separator();
            EditorGUI.indentLevel = 0;
            var exp = EditorGUILayout.BeginToggleGroup("Show Fading Settings", _sounds.showFadingSettings);
            if (exp != _sounds.showFadingSettings) {
                UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _sounds, "toggle Show Fading Settings");
            ...
            EditorGUILayout.Separator();
            EditorGUI.indentLevel = 0;
            var newResource = EditorGUILayout.BeginToggleGroup("Show Resource File Settings", _sounds.resourceAdvancedExpanded);
            if (newResource != _sounds.resourceAdvancedExpanded) {
                UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _sounds, "toggle Show Resource File Settings");
            ...
            if (_sounds.resourceAdvancedExpanded) {
                ...
                if (MasterAudio.HasAsyncResourceLoaderFeature()) {
                    var newAsync = EditorGUILayout.Toggle(new GUIContent("Always Load Resources Async", "Checking this means that you will not have this control per Sound Group or Playlist. All Resource files will be loaded asynchronously."), _sounds.resourceClipsAllLoadAsync);
            ...
            EditorGUI.indentLevel = 0;
            var newLog = EditorGUILayout.BeginToggleGroup("Show Logging Settings", _sounds.logAdvancedExpanded);
            if (newLog != _sounds.logAdvancedExpanded) {
                UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _sounds, "toggle Show Logging Settings");
        ...
        // Music Ducking Start
        EditorGUI.indentLevel = 0;
        GUI.color = _sounds.showMusicDucking ? ActiveClr : InactiveClr;
        EditorGUILayout.BeginHorizontal(EditorStyles.objectFieldThumb);

        var newShowDuck = EditorGUILayout.Toggle("Show Music Ducking", _sounds.showMusicDucking);
        if (newShowDuck != _sounds.showMusicDucking) {
            UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _sounds, "toggle Show Music Ducking");
            _sounds.showMusicDucking = newShowDuck;
        }
        EditorGUILayout.EndHorizontal();
        GUI.color = Color.white;
        ...
        GUI.color = _sounds.areGroupsExpanded ? ActiveClr : InactiveClr;
        EditorGUILayout.BeginHorizontal(EditorStyles.objectFieldThumb);
        var newGroupEx = EditorGUILayout.Toggle("Show Group Mixer", _sounds.areGroupsExpanded);
        if (newGroupEx != _sounds.areGroupsExpanded) {
            UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _sounds, "toggle Show Group Mixer");
            _sounds.areGroupsExpanded = newGroupEx;
        }
        ...
        if (_sounds.areGroupsExpanded) {
            ...
            EditorGUILayout.BeginHorizontal();
            GUILayout.Space(10);
            var labelText = _sounds.showGroupCreation ? "Hide Group Creation" : "Show Group Creation";
            if (GUILayout.Button(labelText, EditorStyles.toolbarButton, GUILayout.Width(140))) {
                UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _sounds, labelText);
            ...
            if (_sounds.groupBuses.Count > 0) {
                ...
                if (voiceLimitedBuses.Count > 0) {
                    ...
                    GUILayout.Space(_sounds.wideMixer ? 476 : 272);
                }
                EditorGUILayout.EndHorizontal();
        ...
        GUI.color = _sounds.playListExpanded ? ActiveClr : InactiveClr;
        EditorGUILayout.BeginHorizontal(EditorStyles.objectFieldThumb);
        var isExp = EditorGUILayout.Toggle("Show Playlist Settings", _sounds.playListExpanded);
        if (isExp != _sounds.playListExpanded) {
            UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _sounds, "toggle Show Playlist Settings");
        ...
        if (_sounds.playListExpanded) {
            ...
            if (plControllerInScene) {
                ...
                GUILayout.Space(Application.isPlaying ? 180 - extraPlaylistLength : 206 - extraPlaylistLength);
            }
            EditorGUILayout.EndHorizontal();
        ...
        // Custom Events Start
        EditorGUI.indentLevel = 0;
        GUI.color = _sounds.showCustomEvents ? ActiveClr : InactiveClr;
        EditorGUILayout.BeginHorizontal(EditorStyles.objectFieldThumb);
        isExp = EditorGUILayout.Toggle("Show Custom Events", _sounds.showCustomEvents);
        if (isExp != _sounds.showCustomEvents) {
            UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _sounds, "toggle Show Custom Events");
