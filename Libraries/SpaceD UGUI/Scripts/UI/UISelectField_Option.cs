...
namespace UnityEngine.UI
{
	public class UISelectField_Option : Toggle {
        ...
        new public bool IsPressed(BaseEventData eventData)
		{
			return base.IsPressed(eventData);
		}
		...
		{
			if (this.selectField == null || this.animator == null || this.animator.runtimeAnimatorController == null || string.IsNullOrEmpty(trigger))
				return;
