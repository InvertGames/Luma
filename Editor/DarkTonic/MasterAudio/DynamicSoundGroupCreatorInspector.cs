...
public class DynamicSoundGroupCreatorInspector : Editor {
    ...
    public override void OnInspectorGUI() {
        ...
        DTGUIHelper.HelpHeader("https://dl.dropboxusercontent.com/u/40293802/DarkTonic/MA_OnlineDocs/DynamicSoundGroupCreators.htm");
            ...
            if (_creator.musicDuckingSounds.Count == 0) {
                ...
                for (var i = 0; i < _creator.musicDuckingSounds.Count; i++) {
                    ...
                    if (newDuckMult != duckSound.duckedVolumeMultiplier) {
                        AudioUndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _creator, "change Ducked Vol Multiplier");
